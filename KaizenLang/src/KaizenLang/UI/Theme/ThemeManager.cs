...
namespace KaizenLang.UI.Theme
{
    public static class ThemeManager
    {
        ...
        public static void ApplyThemeToControl(Control control)
        {
            ...
            if (control is ModernTextBoxBase modernTextBox)
            {
                // modernTextBox.RefreshTheme();
            }
        ...
        private static void ApplyThemeToForm(Form form)
        {
            ...
            // Si es un formulario personalizado, aplicar bordes
            if (form is ModernWindowBase modernWindow)
            {
                modernWindow.SetBorderColor(CurrentTheme.Border);
            }
        }
