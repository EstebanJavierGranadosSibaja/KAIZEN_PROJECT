...
namespace KaizenLang.UI.Theme
{
    ...
    public static class ThemeExtensions
    {
        ...
        /// <summary>
        /// Configura un TextBox como editor de código con sintaxis resaltada
        /// </summary>
        public static void ConfigureAsCodeEditor(this ModernTextBoxBase textBox)
        {
            var theme = ThemeManager.CurrentTheme;

            // textBox.IsMultiline = true;
            textBox.Font = new Font(theme.DefaultFontFamily ?? "Consolas", theme.DefaultFontSize);
            textBox.BackColor = theme.TextBoxBackground;
            textBox.ForeColor = theme.TextBoxForeground;
            // textBox.ShowLineNumbers = true;

            // Configurar para mostrar sintaxis básica
        ...
        /// <summary>
        /// Configura un TextBox como área de salida/log
        /// </summary>
        public static void ConfigureAsOutputArea(this ModernTextBoxBase textBox)
        {
            var theme = ThemeManager.CurrentTheme;

            // textBox.IsMultiline = true;
            textBox.ReadOnly = true;
            textBox.Font = new Font(theme.DefaultFontFamily ?? "Consolas", theme.DefaultFontSize - 1);
            textBox.BackColor = theme.SecondaryBackground;
            textBox.ForeColor = theme.SecondaryForeground;
